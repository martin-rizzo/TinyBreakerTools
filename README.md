...
```bash
maketb --pixart <pixart-model> --sd <sd_model> --resolution 1024
```
...
```bash
maketb --pixart <pixart-model>  --sdxl <sdxl_model> --resolution 1024
```
...
```bash
maketb --pixart pixart-alpha-base.safetensors --sdxl sdxl-base-1.0.safetensors --aux auxiliary.safetensors --resolution 1024
```
...
To know more parameters, use `maketb --help`.
