...
-   **Soporte de PixArt en diferentes resoluciones:** Allows you to integrar modelos pixart de diferentes resoluciones 512px, 1024px, 2048px
...
cd TBMake
# intalar el entorno virtual de python con las dependencias del proyecto
...
-   `--resolution <resolution>`: Declara la resolucion para la que fue entrenado el modelo PixArt (e.g., 1024).
